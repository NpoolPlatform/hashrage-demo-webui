...
export default {
  ...
  MSG_LOGIN_FAQ_MENU_SUBTITLE: 'www.hashrate-demo.npool.topのログインに関する詳細を確認',
  MSG_ACCOUNT_SETTINGS_FAQ_MENU_TITLE: 'アカウント情報',
  MSG_ACCOUNT_SETTINGS_FAQ_MENU_SUBTITLE: 'www.hashrate-demo.npool.topのアカウント情報に関する設定方法を確認',
  MSG_DASHBOARD_FAQ_MENU_TITLE: 'ダッシュボード',
  MSG_DASHBOARD_FAQ_MENU_SUBTITLE: 'www.hashrate-demo.npool.topのマイニングダッシュボードに関する詳細を確認',
  MSG_PAYMENTS_FAQ_MENU_TITLE: '入出金',
  MSG_PAYMENTS_FAQ_MENU_SUBTITLE: 'www.hashrate-demo.npool.topでの支払いに関する詳細を確認',
