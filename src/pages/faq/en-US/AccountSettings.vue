<template>
  <Page>
    <template #body>
      <h2>HashRate Demo Platform - Account Settings</h2>
      ...
      <div class='faq-content'>
        ...
        <div class='faq-content-main'>
          ...
          <ul>
            ...
            <li>(4) Click [Next Step] on www.epool.tech:20402.</li>
            <li>(5) Enter the authentication code from Google Authenticator on www.epool.tech:20402 to complete the two-factor setup.</li>
          </ul>
